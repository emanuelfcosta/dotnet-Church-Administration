...
This is a REST API for managing churches and religious temples. It was developed with C# 8.0 and Mysql.

## Dependencies

[Mysql](https://dev.mysql.com/downloads/)
[Microsoft.EntityFrameworkCore 8.0.15]([https://example.com](https://www.nuget.org/packages/Microsoft.EntityFrameworkCore/8.0.15))
